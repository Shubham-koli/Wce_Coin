    ...
    QSplashScreen(pixmap, f)
{
    ...
    QString copyrightText2   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The WCE developers"));
    QString copyrightText3   = QChar(0xA9)+QString(" %1 ").arg(2018) + QString(tr("WCECoin Developer"));
