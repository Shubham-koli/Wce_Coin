...
"Copyright &copy; 2011-YYYY The Wcecoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Wcecoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>Wcecoin</b> version", Q_NULLPTR));
